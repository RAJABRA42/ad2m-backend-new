...
'web','api',);
        registerArgumentsSet('routes', 'login','logout','dashboard',
'missions.store','missions.show','missions.reject','missions.cancel','missions.pay-advance',
'missions.close','storage.local',);
